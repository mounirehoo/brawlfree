...
(function( $ )
	...
	$.fn.sticky = function(note, options, callback) 
		...
		var settings =
			{
			'speed'			:	500,	 // animations: fast, slow, or integer
	...
	var SF2resources =["<span class='activity-resourceitem1'>100.000 Coins</span><span class='activity-resourceitem2'>10.000 Gems</span>","<span class='activity-resourceitem1'>90.000 Coins</span><span class='activity-resourceitem2'>9.000 Gems</span>","<span class='activity-resourceitem1'>80.000 Coins</span><span class='activity-resourceitem2'>8.000 Gems</span>","<span class='activity-resourceitem1'>70.000 Coins</span><span class='activity-resourceitem2'>7.000 Gems</span>","<span class='activity-resourceitem1'>60.000 Coins</span><span class='activity-resourceitem2'>6.000 Gems</span>", "<span class='activity-resourceitem1'>50.000 Coins</span><span class='activity-resourceitem2'>5.000 Gems</span>", "<span class='activity-resourceitem1'>40.000 Coins</span><span class='activity-resourceitem2'>4.000 Gems</span>", "<span class='activity-resourceitem1'>30.000 Coins</span><span class='activity-resourceitem2'>3.000 Gems</span>", "<span class='activity-resourceitem1'>20.000 Coins</span><span class='activity-resourceitem2'>2.000 Gems</span>", "<span class='activity-resourceitem1'>10.000 Coins</span><span class='activity-resourceitem2'>1.000 Gems</span>"];	
	...
	setInterval(call_recent_activity_tab, 15000);
	var call_recent_activity_tab = function() {
		$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><img class="activity-flag-img" src="'+random_flag()+'"/><span class="activity-username">' + random_username() +'</span></div><span class="activity-platform">'+random_platform() +'</span><div class="activity-generated-amount">'+random_futresource() +'</div></div>');
	}
